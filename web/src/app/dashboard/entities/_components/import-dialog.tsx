...
import { useImportEntities } from '@/hooks/queries/use-imports'
...
export function EntityImportDialog({ open, onOpenChange }: EntityImportDialogProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (result.success) {
                setCreatedCount('created_count' in result.data ? result.data.created_count : 0)
                setState('success')
            } else {
            ...
            const axiosErr = err as { response?: { data?: { error?: { message?: string; details?: { errors?: ImportError[] } }; message?: string; data?: { errors?: ImportError[] } } } }
    ...
    const handleDownloadTemplate = async () => {
        try {
            await importsApi.downloadTemplate('entities')
        } catch (error) {
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    <DialogTitle>Toplu Varlık Yükleme</DialogTitle>
                    <DialogDescription>
                        ...
                        <div className="flex items-center gap-3 rounded-lg border border-green-200 bg-green-50 p-4">
                            ...
                            <div>
                                <p className="text-sm font-medium text-green-800">
                                    {createdCount} varlık başarıyla oluşturuldu
                                </p>
                            </div>
                        </div>
